...
import UserUpdating from "./AdminUserUpdating";
...
const AdminUser: React.FC<UserProps> = ({ email, fullname, group_name, isBlocked, mobile, _id, address, type }) => {
                ...
                <div className="absolute top-14 right-6 flex gap-2">
                    ...
                    {userType === "administrator" && (
                        <>
                            ...
                            {checkPermission(permissions, "511246447") && (
                                <button
                                    onClick={() => {
                                        if (isBlocked) {
