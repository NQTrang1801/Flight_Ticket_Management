...
const YearlyRevenue: React.FC<YearlyRevenueProps> = ({ year, monthlyRevenue }) => {
    ...
    return (
        <>
            <div>
                <div className="font-semibold text-base capitalize">Year: {year}</div>
                <table className="w-full bg-block mt-4">
                    ...
                    <tbody>
                        {monthlyRevenue.map((flight) => (
                            <tr key={flight.stt} className="text-center">
                                <td>{flight.stt}</td>
                                <td>{flight.month}</td>
                                <td>{flight.flightCount}</td>
