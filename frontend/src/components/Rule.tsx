...
const Rule: React.FC<RuleProps> = ({ code, ruleName, ruleDetail, value, _id }) => {
        ...
        <>
            <div className="p-6 rounded-xl overflow-hidden shadow-xl border border-primary bg-background relative">
                ...
                <div className="flex flex-col gap-4 mt-8">
                    <div>
                        <span className="font-semibold">Rule detail</span>: {ruleDetail}
                    </div>
                    <div>
                            ...
                            ? Object.entries(value).map(([key, val]) =>
                                  typeof val !== "object" ? (
                                      ...
                                      Object.entries(val).map(([subKey, subVal]) => (
                                          <div key={subKey}>
                                              {Object.entries(subVal).map(([sub2Key, sub2Val]) => (
                                                  <div key={sub2Key}>
                                                      {sub2Key}: {sub2Val}
                                                  </div>
                                              ))}
