...
function Dashboard() {
    ...
    useEffect(() => {
        if (permissions.length > 0 && permissions.some((permission) => permission.functionalityCode === "511320884")) {
            (async () => {
                await axios
    ...
    return (
        <>
            ...
            permissions.some((permission) => permission.functionalityCode === "511320884") ? (
